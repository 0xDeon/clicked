...
_Note: Validation constraints for these models are enforced natively by Pydantic based on their type annotations. The AI Agent endpoint strictly coerces payloads and raises HTTP 422 Unprocessable Entity if payloads do not match these definitions._
